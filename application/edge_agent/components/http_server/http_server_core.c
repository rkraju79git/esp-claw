...
esp_err_t http_server_start(void)
{
    ...
    config.max_uri_handlers = 56;  /* core routes + /voice (2) + /hwtest (12) */
    ...
    ESP_RETURN_ON_ERROR(http_server_register_voice_routes(s_ctx.server), TAG, "Failed to register voice routes");
#endif
    ESP_RETURN_ON_ERROR(http_server_register_hwtest_routes(s_ctx.server), TAG, "Failed to register hwtest routes");
